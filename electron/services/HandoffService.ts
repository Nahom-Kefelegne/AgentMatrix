...
export async function prepareHandoff(
  ...
  // The provider owns the per-CLI transcript layout; never rebuild those paths
  // here. Claude: projects/<project>/<id>.jsonl. Copilot:
  // session-state/<id>/events.jsonl. Kimi: .../agents/main/wire.jsonl.
