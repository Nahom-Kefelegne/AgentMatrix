...
export const MEETING_POSITIONS: Point[] = [
  { x: 8, y: 12 },
  { x: 10, y: 12 },
  { x: 12, y: 12 },
  { x: 14, y: 12 },
...
export const OFFICE_GRID: TileType[][] = [
  ...
  // Row 9: Open space
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 10: Meeting carpet start
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 11: Meeting rug + overflow
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.OVERFLOW,T.OVERFLOW,T.OVERFLOW,T.OVERFLOW,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 12: Meeting chairs top + overflow
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.OVERFLOW,T.OVERFLOW,T.OVERFLOW,T.OVERFLOW,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 13: Meeting table + waiting
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.WAITING,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 14: Meeting table + waiting
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.MEETING_TABLE,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.WAITING,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 15: Meeting chairs bottom
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.MEETING_CHAIR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 16: Meeting rug
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
  // Row 17: Meeting carpet end
  [T.WALL,T.FLOOR,T.FLOOR,T.FLOOR,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.CARPET,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.FLOOR,T.WALL],
